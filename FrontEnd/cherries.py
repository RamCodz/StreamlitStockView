...
with Cherry_tabs[2]:
    display_stock_data_from_df(stock_list_df, key_prefix="Cherries6M")
with Cherry_tabs[3]:
    display_stock_data_from_df(stock_list_df, key_prefix="Cherries3M")
with Cherry_tabs[4]:
    display_stock_data_from_df(stock_list_df, key_prefix="Cherries1M")
