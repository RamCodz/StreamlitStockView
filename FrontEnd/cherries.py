    ...
    if not df.empty:
        ...
        for index, row in df.iterrows():
            ...
            st.markdown(
                ...
                f'<div style="flex:1; {colors[0]}; margin:0; padding:5px;">{row["1W_value"]}%</div>' +
                f'<div style="flex:1; {colors[0]}; margin:0; padding:5px;">{row["1M_value"]}%</div>' +
                f'<div style="flex:1; {colors[1]}; margin:0; padding:5px;">{row["3M_value"]}%</div>' +
